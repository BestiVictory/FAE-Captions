...
def extract_imgs_feat():
    ...
    print('\n',os.path.join(opt.out_feats_dir, '%s_fc.h5' % opt.dataset_name),'\n')
...
def process_coco_captions():
    ...
    with open(opt.out_captions, 'w') as f1:
      json.dump(captions, f1)
    with open(opt.out_annotation, 'w') as f2:
      json.dump(annotation, f2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_coco', type=str, default='/mc/isarir/pth_focus/Focus1.json')
